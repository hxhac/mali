...
type GoodsEvaluation struct {
	...
	// Category      *int          `json:"category" form:"category" gorm:"column:category;comment:分类;not null;"`
	// GoodsCategory GoodsCategory `json:"goods_category" gorm:"foreignKey:Category"`
	Category   string     `json:"category" form:"category" gorm:"column:category;comment:分类;size:255;not null;default:;"`
