...
type GoodsEvaluation struct {
	...
	Category     pq.Int64Array `json:"category" form:"category[]" gorm:"type:varchar(255)[];column:category;comment:分类;size:255;not null;default:'{}';"`
	CategoryName string        `json:"categoryName" form:"categoryName" gorm:"column:category_name;comment:分类名;size:255;default='';not null;"`
