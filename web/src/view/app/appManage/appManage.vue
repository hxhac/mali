<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="app标签（0核心应用、1增强应用、2已删除应用）" prop="appLabel" width="120" />
        <el-table-column align="left" label="md-textarea" prop="appMore" width="120" />
        <el-table-column align="left" label="app名称" prop="appName" width="120" />
        <el-table-column align="left" label="app备注" prop="appRemark" width="120" />
        <el-table-column align="left" label="app的url" prop="appUrl" width="120" />
