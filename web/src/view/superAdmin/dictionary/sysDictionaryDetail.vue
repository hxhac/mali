	...
	<div>
		...
		<div class="gva-table-box">
			<div class="gva-btn-list">
				<el-button size="small" type="primary" icon="plus" @click="openDialog">新增字典项
				</el-button>
			</div>
			<el-table
				ref="multipleTable"
				...
				<el-table-column align="left" label="按钮组">
					<template #default="scope">
						<el-button size="small" type="text" icon="edit"
						           @click="updateSysDictionaryDetailFunc(scope.row)">变更
						</el-button>
						<el-popover v-model:visible="scope.row.visible" placement="top" width="160">
							...
							<div style="text-align: right; margin-top: 8px;">
								...
								<el-button type="primary" size="small"
								           @click="deleteSysDictionaryDetailFunc(scope.row)">确定
								</el-button>
							</div>
							<template #reference>
		...
		<el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
			<el-form ref="dialogForm" :model="formData" :rules="rules" size="medium"
			         label-width="110px">
