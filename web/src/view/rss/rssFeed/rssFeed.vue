<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="rss分类" prop="cateId" width="120" />
        <el-table-column align="left" label="rss的url" prop="url" width="120" />
        <el-table-column align="left" label="关键字过滤，逗号连接" prop="keywords" width="120" />
        <el-table-column align="left" label="是否暂停（0不暂停1暂停）" prop="isPause" width="120">
