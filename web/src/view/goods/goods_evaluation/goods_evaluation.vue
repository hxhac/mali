<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="品牌id" prop="brand_id" width="120" />
        <el-table-column align="left" label="价格" prop="price" width="120" />
        <el-table-column align="left" label="分类id" prop="cate_id" width="120" />
        <el-table-column align="left" label="综合评分" prop="rank" width="120" />
        <el-table-column align="left" label="商品备注" prop="detail" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="品牌id:">
          <el-input v-model.number="formData.brand_id" clearable placeholder="请输入" />
        </el-form-item>
        <el-form-item label="价格:">
          <el-input v-model.number="formData.price" clearable placeholder="请输入" />
        </el-form-item>
        <el-form-item label="分类id:">
          <el-input v-model.number="formData.cate_id" clearable placeholder="请输入" />
        </el-form-item>
