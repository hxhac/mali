...
<!--        </el-table-column>-->
        ...
        <el-table-column align="left" label="按钮组" min-width="10%">
            ...
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateLifeYearlyFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getLifeYearlyList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
